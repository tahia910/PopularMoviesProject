...
public class SettingsActivity extends AppCompatActivity {
    ...
    // The user can edit the movie poster sort order in the PreferenceFragment.
    public static class MoviesPreferenceFragment extends PreferenceFragment implements Preference
